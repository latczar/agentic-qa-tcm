...
| 9     | CI hardening                         | badges, a manual (`workflow_dispatch`-only) Ollama bench job that never gates a merge, `docker compose config` validation kept in `checks`                                             | TBC once the first real GitHub Actions run is checked, not just the YAML                                                                                                                                                                                                   |
