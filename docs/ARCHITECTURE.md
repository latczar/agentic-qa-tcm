...
| 1     | HR Portal                            | five features, roles, seed and reset endpoints, `data-testid` everywhere, health endpoint                                                                                              | manual walkthrough of every feature; container in compose                                                            |
| 2     | Playwright framework                 | page objects, fixtures, helpers, conventions, 8 to 10 exemplar tests, custom ESLint rules with unit tests                                                                              | suite green in CI against the app; lint rules tested                                                                 |
